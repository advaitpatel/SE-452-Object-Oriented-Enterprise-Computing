...
public class Helper {
	...
	public void displayProduct(String name,String type,String maker, String acc,boolean delete){
		System.out.println("dis" + name+ "," + type +"," +maker+","+acc);
		if(type.equals("consoles")){
			...
			pw.print("<li><a class='btnbuy' href='DeleteProduct?name="+name+"&type="+type+"&maker="+maker+"&access="+acc+"'>Delete</a></li>");
			pw.print("<li><a class='btnreview' href='#'>Edit</a></li>");
			pw.print("</ul></div>");
		}
		if(type.equals("games")){
			...
			if(maker.equals("electronicArts")){
				if(delete){
					GameHashMap.electronicArts.remove(name);
					return;
				}
				...
				if(delete){
					GameHashMap.activision.remove(name);
					return;
				}
				...
				if(delete){
					GameHashMap.takeTwoInteractive.remove(name);
					return;
				}
		...
		if(type.equals("accessories")){
			...
			if(delete){
				console.getAccessories().remove(name);
				return;
			}
			...
			pw.print("<li id='item'><img src='images/games/"+accessory.getImage()+"' alt='' /></li>");
			pw.print("<li><a class='btnbuy' href='DeleteProduct?name="+name+"&type="+type+"&maker="+maker+"&access="+acc+">Delete</a></li>");
			pw.print("<li><a class='btnreview' href='#'>Edit</a></li>");
			pw.print("</ul></div>");
		}
