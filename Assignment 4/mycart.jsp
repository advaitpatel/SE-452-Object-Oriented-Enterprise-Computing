    ...
    synchronized (session) {
        ...
        if (id != null && !id.isEmpty()) {
            ...
            if (strQuantity == null) {
                ...
                String item_maker = request.getParameter("maker");
                //String item_access = request.getParameter("access");
                String item_access = "Customer";
                ...
                String user_name = "";
                user_name = session.getAttribute(Constants.SESSION_USERNAME).toString();

                int i = st.executeUpdate("insert into se452db values ('" + item_id + "','" + item_name + "','" + item_type + "','" + item_maker + "'  ,'" + user_name + "'  )");
